...
var MenProductsComponent = (function () {
    function MenProductsComponent() {
        this.productList = [{ id: 1, name: 'laptop' }, { id: 2, name: 'Computers' }, { id: 3, name: 'Smart Phones' }];
    }
...
MenProductsComponent = __decorate([
    core_1.Component({
        ...
        template: "<ul>\n                <li *ngFor=\"let product of productList\"><a [routerLink]=\"['productdetails',product.id]\">{{product.name}}</a></li>\n                <ul>\n                <router-outlet></router-outlet>"
    }),
